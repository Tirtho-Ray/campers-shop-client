...
import {
  ...
  TProduct,
  useAllProductQuery,
} from "../../readux/Api/Api"; // Adjust path as necessary
...
const ProductTable: React.FC = () => {
  ...
  if (error)
    return <div className="h-lvh text-center py-64">Error occurred ...</div>;
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              <th
                scope="col"
                className="px-6 py-3 text-left text-[10px] md:text-[8px] lg:text-[15px] font-medium text-gray-500 uppercase tracking-wider"
              >
                #
              </th>
              <th
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {productsList.map((product, index) => (
              <tr key={product.id}>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 md:text-xs sm:text-base">
                  {index + 1}
                </td>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-[8px] md:text-[12px]  sm:text-base text-gray-900">
                  {product.name}
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-[8px] md:text-[12px] sm:text-base text-gray-900">
                  ${product.price}
                ...
                <td className="px-6 py-4 whitespace-nowrap text-[8px] sm:text-base font-medium">
                  ...
                  <button
                    ...
                    className={`text-red-600 hover:text-red-900 border p-2 ${
